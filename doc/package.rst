...
.. note::
   ...
   :file:`zkg.meta` is the canonical metadata file name used since
   :program:`zkg` v2.0.  The previous metadata file name of :file:`bro-pkg.meta`
   is also accepted when no :file:`zkg.meta` exists.
