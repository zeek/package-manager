"""
This module provides abstractions for the output directly resulting from the
command-line arguments. It has (basic) support for progress indication and
confirmation prompts, and supports its own level of log/info/warn output. In
contrast to the logging functionality in zeekpkg/log, the UI output focuses on
stdout.
"""
