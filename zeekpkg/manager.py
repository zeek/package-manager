...
class Manager:
    ...
    def __init__(self) -> None:
        ...
        self._state_lock = open(os.path.join(CONFIG.state_dir(), ".lock"), "a")
    ...
    def package_test_log(self, pkg_path: str) -> str:
        """Return the path to the package manager's test log for a package.

        The test log is of the form <name>-test.log, resides in the log
        directory of zkg's internal state, and combines stdout and stderr in
        separate sections of the file.
